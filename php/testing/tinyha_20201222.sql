...
CREATE TRIGGER reed_log AFTER INSERT ON reed
WHEN new.reed <> (SELECT reed FROM reed_log ORDER BY id DESC LIMIT 1)
BEGIN
    INSERT INTO reed_log (reed) VALUES (new.reed);
END;
INSERT INTO reed_log (reed) VALUES ('dummy');
